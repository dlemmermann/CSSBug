...
public class SettingsPane extends VBox {
    ...
    private final BooleanProperty showSpotlightIn = new SimpleBooleanProperty(this, "showSpotlightIn");
    private final BooleanProperty showSpotlightOut = new SimpleBooleanProperty(this, "showSpotlightOut");
    private final BooleanProperty showTextBoxIn = new SimpleBooleanProperty(this, "showTextBoxIn");
    private final BooleanProperty showTextBoxOut = new SimpleBooleanProperty(this, "showTextBoxOut");
    ...
    private final BooleanProperty showShapesIn = new SimpleBooleanProperty(this, "showShapesIn");
    ...
    public SettingsPane() {
        ...
        closeButton.setOnAction(evt -> getOnClose().run());
